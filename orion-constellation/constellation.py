...
#This code generates a 2d and 3d plot to visualize the orion constellation
...
#create a 2d representation of the orion constellation
fig = plt.figure()
...
#create a 3d representation of the orion constellation
fig_3d = plt.figure()
projection=fig_3d.add_subplot(1,1,1, projection="3d")
constellation3d = plt.scatter(x,y,z, c="green", marker="o")
plt.title("3d plot of the Orion Constellation")
projection.set_xlabel("X coordinates")
projection.set_ylabel("Y coordinates")
projection.set_zlabel("Z coordinates")
